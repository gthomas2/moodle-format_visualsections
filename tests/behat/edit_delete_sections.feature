@format @format_visualsections
Feature: Sections can be edited and deleted in visualsections format
  In order to rearrange my course contents
  As a teacher
  I need to edit and Delete visualsections
  ...
  Background:
    ...
    And the following "courses" exist:
      ...
      | Course 1 | C1        | visualsections | 0             | 5           |
  ...
  @javascript
  Scenario: Inline edit section name in visualsections format
  ...
  Scenario: Deleting the last section in visualsections format
  ...
  Scenario: Deleting the middle section in visualsections format
